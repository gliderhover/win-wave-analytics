                  ...
                  <TabsContent value="ingame">
                    {isElite ? (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <InGameTimeline
                          shapeChanges={lineup.homeShapeChanges}
                          teamName={match.teamA}
                          initialFormation={lineup.homeFormation}
                        />
                        <InGameTimeline
                          shapeChanges={lineup.awayShapeChanges}
                          teamName={match.teamB}
                          initialFormation={lineup.awayFormation}
                        />
                      </div>
                    ) : (
                      <div className="space-y-4">
                        <div className="bg-secondary/30 border border-border rounded-lg p-4">
                          ...
                          <p className="text-[10px] text-muted-foreground mb-3">Pro preview — upgrade to Elite for full in-game timeline with minute-by-minute shape changes.</p>
                  ...
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm font-mono flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-[250px]">
                          <p className="text-xs">Each signal scores 0–100 based on tactical matchup analysis. Higher = stronger factor.</p>
                        </TooltipContent>
                      </Tooltip>
                    </CardTitle>
                  </CardHeader>
