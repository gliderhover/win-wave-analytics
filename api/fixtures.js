export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `https://api.sportmonks.com/v3/football/fixtures/between/${startDate}/${endDate}?api_token=${token}&per_page=50&include=${encodeURIComponent(include)}&filters=fixtureLeagues:${encodeURIComponent(leagueIdsStr)}`;
